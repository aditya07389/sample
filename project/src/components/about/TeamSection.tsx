...
const teamMembers: TeamMember[] = [
  {
    ...
    role: "Web Developer",
    description:
      "Designed and developed both the front-end and back-end components of the application, ensuring seamless integration between the user interface and server-side functionality.",
  ...
  },
  {
    ...
    description:
      "Expert in GIS mapping and solar radiation modeling for optimal site selection.",
  ...
  },
  {
    ...
    description:
      "Data analytics to provide accurate insights for solar site selection and the features needed for it.",
      ...
      <div className="container mx-auto px-4">
        <AnimatedSection className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
            Our diverse team of experts combines knowledge in renewable energy,
